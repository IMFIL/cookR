...
public class EditRecipe extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currentActionBar.setCustomView( ActionBarSetter.getActionBarView("Edit Recipe",this));

        currentActionBar.setDisplayShowCustomEnabled(true);


        EditText name = ((EditText) findViewById(R.id.recipeNameEntry));
        name.setText(RR.getName());
        EditText prep = ((EditText) findViewById(R.id.prepEntry));
        prep.setText(RR.getPrepTime());
        EditText cook = ((EditText) findViewById(R.id.cookEntry));
